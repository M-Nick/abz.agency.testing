  ...
  <footer class="footer">
    <div class="footer__top">
      ...
      <ul class="footer__menu">
        <li class="footer__item">
          <a href="" class="link-on-dark footer__link">About me</a>
        </li>
        <li class="footer__item">
          <a href="" class="link-on-dark footer__link">Relationships</a>
        </li>
        <li class="footer__item">
          <a href="" class="link-on-dark footer__link">Requirements</a>
        </li>
        <li class="footer__item">
          <a href="" class="link-on-dark footer__link">Users</a>
        </li>
        <li class="footer__item">
          <a href="" class="link-on-dark footer__link">Sign Up</a>
        </li>
      </ul>
    ...
    <div class="footer__middle">
      <ul class="footer__contacts">
        <li class="footer__contact footer__contact--email">
          <svg class="icon-on-dark" viewBox="0 0 24 18">
            <path
            ...
            ></path>
            <polygon points="0 1.5 0 15.75 8.29 8.71"></polygon>
            <polygon points="15.71 8.71 24 15.75 24 1.5"></polygon>
          </svg>
          <a href="">work.of.future@gmail.com</a>
        </li>
        <li class="footer__contact footer__contact--phone">
          <svg class="icon-on-dark" viewBox="0 0 20 20">
            <path
    ...
    <div class="footer__bottom">
      ...
      <ul class="footer__socials">
        <li class="footer__social">
          <a href="">
            <svg class="icon-on-dark" viewBox="0 0 26 26">
              <path
        ...
        <li class="footer__social">
          <a href="">
            <svg class="icon-on-dark" viewBox="0 0 26 26">
              <path
                d="M15.3,11.32 C14.7722708,10.5663332 13.9100607,10.1174981 12.99,10.1174981 C12.0699393,10.1174981 11.2077292,10.5663332 10.68,11.32 C10.3310448,11.8109066 10.1424294,12.3977102 10.14,13 C10.14,14.5740115 11.4159885,15.8499999 12.99,15.8499999 C14.5640115,15.8499999 15.84,14.5740115 15.84,13 C15.8375706,12.3977102 15.6489552,11.8109066 15.3,11.32 Z"
              ></path>
              <path
                d="M17.09,11.34 C17.3171443,11.8634612 17.4296627,12.4294627 17.42,13 C17.42,15.4466214 15.4366214,17.43 12.99,17.43 C10.5433786,17.43 8.56,15.4466214 8.56,13 C8.54894702,12.4325683 8.66155427,11.869532 8.89,11.35 L6.39,11.35 L6.39,18 C6.43576145,18.8661414 7.13335431,19.5550685 8,19.59 L18,19.59 C18.8588477,19.5451003 19.5451003,18.8588477 19.59,18 L19.59,11.34 L17.09,11.34 Z"
              ></path>
              <polygon
                points="18.84 6.76 16.45 6.76 16.45 9.51 19.18 9.51 19.18 7.11 19.18 6.74"
              ></polygon>
              <path
