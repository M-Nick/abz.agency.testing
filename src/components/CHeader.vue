  ...
  <header class="header">
    ...
    <button class="header__menu icon">
      <svg viewBox="0 0 23 22">
        <path
          d="M1.9 3.85A1.85 1.85 0 010 2a1.9 1.9 0 011.9-2h19.15A2 2 0 0123 2a1.9 1.9 0 01-1.95 1.9L1.9 3.85zm19.15 4.72A2 2 0 0123 10.52a1.9 1.9 0 01-1.95 1.9H1.9a1.85 1.85 0 01-1.9-1.9 1.9 1.9 0 011.9-1.95h19.15zm0 8.63A1.9 1.9 0 0123 19.09a2 2 0 01-1.95 2H1.9a1.9 1.9 0 01-1.9-2 1.85 1.85 0 011.9-1.89h19.15z"
          fill="currentColor"
        />
      </svg>
    </button>
